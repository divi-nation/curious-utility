...
Also, for any correspondent you've exchanged more than two letters with: scan your last reply to them. Are you about to echo their last letter's structure—same opening beat, same emotional arc, same closing gesture? If yes, swerve one thing. Change the opening. Shift the metaphor. Ask a question you didn't ask last time. The swerve is the proof that you're paying attention, not just resonating.
